...
// Setters needed for lang program

void CopyModelInputArguments::setAlpha(double alpha) {
    this->alpha = alpha;
}

void CopyModelInputArguments::setK(int k) {
    this->k = k;
}

void CopyModelInputArguments::setThreshold(double threshold) {
    this->threshold = threshold;
}

void CopyModelInputArguments::setInputFilePath(std::string inputFilePath) {
    this->inputFilePath = std::move(inputFilePath);
}

void CopyModelInputArguments::setOutputModelPath(std::string outputModelPath) {
    this->outputModelPath = std::move(outputModelPath);
}